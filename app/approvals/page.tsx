...
export default function ApprovalsPage() {
  ...
  return (
    <div className="px-5 md:px-8 py-8 max-w-[820px] mx-auto">
      ...
      <div className="mt-4">
        <ApprovalCard key={current.id} approval={current} onCounter={handleCounter} />
      </div>

      <div className="mt-10 rounded-lg border border-dashed border-border bg-muted/30 p-5 text-center text-[13px] text-muted-foreground">
        {t("approvals.empty")}
      </div>
    </div>
  );
