...
export function NotificationPermissionPill() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-2 rounded-lg border border-accent/30 bg-accent/10 px-3 py-2 text-left hover:bg-accent/15 transition-colors"
    >
      <Bell className="h-3.5 w-3.5 shrink-0 text-accent" />
      <div className="min-w-0 flex-1">
        <div className="text-[13px] font-medium text-accent">{t("notify.enable")}</div>
