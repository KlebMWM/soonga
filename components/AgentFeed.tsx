  ...
  useEffect(() => {
    const tick = () => {
      ...
      if (next.status === "pending") {
        ...
        // simulator. Bare-bones context — enough to render the card without
        // pretending the AI did rich reasoning. Real data gets richer
        // approvals; this is the "simulator path" placeholder.
        pendingStore.add({
          id: `synth_${next.id}`,
          agent: next.agent,
